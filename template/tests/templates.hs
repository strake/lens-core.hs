...
makeLensesWith (lensField .~ underscoreNoPrefixNamer $ lensRules) ''CheckUnderscoreNoPrefixNamer
...
makeLensesWith (lensField .~ (mappingNamer (return . ("hogehoge_" ++))) $ lensRules) ''CheckMappingNamer
...
makeLensesWith (lensField .~ lookingupNamer [("fieldLookingupNamer", "foobarFieldLookingupNamer")] $ lensRules) ''CheckLookingupNamer
...
makeLensesWith (lensField .~ underscoreNamer $ defaultFieldRules) ''CheckUnderscoreNamer
...
makeLensesWith (lensField .~ camelCaseNamer $ defaultFieldRules) ''CheckCamelCaseNamer
...
makeLensesWith (lensField .~ abbreviatedNamer $ defaultFieldRules) ''CheckAbbreviatedNamer
